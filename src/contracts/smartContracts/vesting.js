...
contract VestingContract is Ownable2Step, ReentrancyGuard, Pausable {
  ...
  description:
    "💡 Lock tokens securely with a custom vesting schedule. In this tutorial, we build a Solidity vesting contract from scratch, perfect for managing team allocations, advisor tokens, or investor unlocks.\n\n" +
    "What you'll learn:\n" +
    "• How to create a linear token vesting schedule\n" +
    '• The purpose and implementation of a "cliff period"\n' +
    "• Managing beneficiary addresses and vested amounts\n" +
    "• Secure withdrawal patterns to prevent reentrancy\n" +
    "• Practical use-cases for startups and DAOs\n\n" +
    "This is a practical, beginner-friendly guide to an essential DeFi and Web3 business primitive.",
  github: "https://github.com/0xGondarxyz/vesting-contract",
};
